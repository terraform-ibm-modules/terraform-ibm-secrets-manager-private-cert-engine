...
| <a name="input_intermediate_ca_name"></a> [intermediate\_ca\_name](#input\_intermediate\_ca\_name) | Name of the Intermediate CA to create for a private\_cert secret engine. If a prefix input variable is specified, it is added to the value in the `<prefix>-value` format. | `string` | `"intermediate-ca"` | no |
...
| <a name="input_root_ca_name"></a> [root\_ca\_name](#input\_root\_ca\_name) | The name of the Root CA to be created for a private\_cert secret engine. If a prefix input variable is specified, it is added to the value in the `<prefix>-value` format. | `string` | `"root-ca"` | no |
