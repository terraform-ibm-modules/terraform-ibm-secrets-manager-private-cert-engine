module github.com/terraform-ibm-modules/terraform-ibm-secrets-manager-private-cert-engine
...
require (
	...
	github.com/terraform-ibm-modules/ibmcloud-terratest-wrapper v1.60.7
)
